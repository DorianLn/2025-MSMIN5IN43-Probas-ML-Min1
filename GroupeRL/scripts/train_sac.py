"""
Entraînement d'un agent SAC sur Doom (VizDoom) - Scénario Custom
...
# Créer le modèle SAC avec MultiInputPolicy pour les dict observations
model = SAC(
...
model.save("models/sac_doom_custom")
print("-" * 60)
print(f"\n✅ Entraînement SAC sur Doom terminé avec succès !")
print(f"   Modèle sauvegardé : models/sac_doom_custom.zip")
